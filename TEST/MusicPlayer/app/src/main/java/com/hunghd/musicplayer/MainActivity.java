...
public class MainActivity extends AppCompatActivity {
    ...
    String urlGetData = "http://192.168.1.7/androidwebservices/getdata.php";
    ...
    private void loadSongs(String urlGetData){
//        String name = "Candy";
//        String artist = "Red Velvet";
//        String url = "https://aredir.nixcdn.com/NhacCuaTui889/Candy-RedVelvet-3824610_hq.mp3";
